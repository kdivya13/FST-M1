...
public class gitHubProject {
    ...
    String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFAipdqM8kINT2KlPdaJJq6/oXKKurGQErGSKSb9zWra\n";
    int sshKeyId;


    RequestSpecification requestSpec = new RequestSpecBuilder()
            .setBaseUri("https://api.github.com/user/keys")
            .addHeader("Authorization", "token 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")
